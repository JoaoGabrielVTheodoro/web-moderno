 ...
 * valores numéricos e um número inteiro. Faça com que a primeira função retorne
 * outro vetor que será resultado da multiplicação de cada elemento pelo número
 * passado como parâmetro. A segunda função fará o mesmo da primeira se e
